...
app = Flask('')
@app.route('/')
def home(): return "Boti i Infos Road Macedonia është Live!"
...
def handle_incoming_message(message):
    ...
    # --- NJOFTIMI I MENJËHERSHËM PËR TY (ADMININ) ---
